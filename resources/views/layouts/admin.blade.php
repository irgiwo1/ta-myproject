        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/admin/master/lokasi">Lokasi</a></li>
                    <li><a href="/admin/master/jenisKendaraan">Jenis Kendaraan</a></li>
                    <li><a href="/admin/master/tipe">Tipe</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/admin/laporan/kegiatan">Kegiatan</a></li>
                    <li><a href="/admin/laporan/setoranPerUser">Setoran Per User</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/admin/kegiatan/harian">Harian</a></li>
                    <li><a href="/admin/kegiatan/mingguan">Mingguan</a></li>
                    <li><a href="/admin/kegiatan/bulanan">Bulanan</a></li>
                </ul>
            </li>

            <!-- User Management Menu -->
            <li>
                <a href="/admin/userManagemen">
