    ...
    <!--**********************************
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/pengawas/dashboard" class="brand-logo">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/pengawas/master/lokasi">Lokasi</a></li>
                    <li><a href="/pengawas/master/jenisKendaraan">Jenis Kendaraan</a></li>
                    <li><a href="/pengawas/master/tipe">Tipe</a></li>
                </ul>
            </li>

            <!-- Setoran Menu -->
            <li>
                <a href="/pengawas/setoran">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/pengawas/laporan/kegiatan">Kegiatan</a></li>
                    <li><a href="/pengawas/laporan/setoranPerUser">Setoran Per User</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="/pengawas/kegiatan/harian">Harian</a></li>
                    <li><a href="/pengawas/kegiatan/mingguan">Mingguan</a></li>
                    <li><a href="/pengawas/kegiatan/bulanan">Bulanan</a></li>
                </ul>
            </li>

            <!-- User Management Menu -->
            <li>
                <a href="/pengawas/userManagemen">
