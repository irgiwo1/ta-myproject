    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('pengawas.laporan.kegiatan.index') }}" method="GET">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="btn-group" role="group">
                                <a href="{{ route('pengawas.laporan.kegiatan.cetak', request()->all()) }}" class="btn btn-secondary btn-sm mr-2">Cetak PDF</a>
