    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('pengawas.laporan.setoranPerUser.index') }}" method="GET">
                            <div class="d-flex flex-wrap mb-4">
                                ...
                                <div class="form-group d-flex align-items-end">
                                    ...
                                    <a href="{{ route('pengawas.laporan.setoranPerUser.cetak-pdf', request()->all()) }}" class="btn btn-danger">Cetak PDF</a>
                                </div>
                            </div>
                        </form>
                    </div>
