                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.setoran.create') }}" class="btn btn-success">Tambah Setoran</a>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                        ...
                                        @forelse ($setorans as $setoran)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <!-- Edit Button -->
                                                        <a href="{{ route('admin.setoran.edit', $setoran->id_setoran) }}" class="btn btn-warning btn-sm mr-2">Edit</a>

                                                        <!-- Delete Button -->
                                                        <form action="{{ route('admin.setoran.destroy', $setoran->id_setoran) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
