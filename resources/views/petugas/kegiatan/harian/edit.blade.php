...
<div class="content-body">
    <div class="container-fluid">
        ...
        <form action="{{ route('petugas.kegiatan.harian.update', $kegiatanHarian->id_kegiatan) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <a href="{{ route('petugas.kegiatan.harian.index') }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection
