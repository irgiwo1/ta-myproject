...
<div class="content-body">
    <div class="container-fluid">
        <h4>Tambah Kegiatan Mingguan</h4>
        <form action="{{ route('petugas.kegiatan.mingguan.store') }}" method="POST">
            @csrf
            ...
            <a href="{{ route('petugas.kegiatan.mingguan.index') }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection
